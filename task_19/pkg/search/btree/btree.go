...
func (t *Tree) Insert(doc structs.Document) {
...
func (t *Tree) Search(x int) (structs.Document, bool) {
	return search(t.root, x)
}
func search(el *Element, x int) (structs.Document, bool) {
	if el == nil {
		return structs.Document{}, false
	}
	if el.value.ID == x {

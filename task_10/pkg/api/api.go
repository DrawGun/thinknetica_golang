...
var (
	...
	queryLength = promauto.NewHistogram(prometheus.HistogramOpts{
		Name:    "query_length_in_bytes",
		Help:    "Размер поискового запроса, bytes",
		Buckets: prometheus.LinearBuckets(2, 2, 10), // 10 корзин, начиная с 0, с шагом 2 байт
	})
)
...
func (s *Service) Search(w http.ResponseWriter, r *http.Request) {
	...
	// измеряем длинну поискового запроса
	queryLength.Observe(float64(len(query)))
